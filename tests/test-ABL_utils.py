"""Tests all code in src.bacsim.abl_utils."""
import unittest

from src.bacsim.abl_utils import is_zero

class TestablUtils(unittest.TestCase):

    """Class to test the code in src.bacsim.abl_utils."""
